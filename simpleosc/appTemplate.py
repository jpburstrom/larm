...
def myTest():
    ...
    """
    # init() creates under the hood an outbound socket and the callback manager
    ...
    while 1:
        osc.sendMsg("/test", [444], "127.0.0.1", 9000) # send normal msg
        ...
        osc.sendBundle(bundle, "127.0.0.1", 9000) # send the fucker
